					...
					//$res = mysqli_query($con, $sql);
					  ?>
						<tr>
							...
							<td>
							<a href="Restore.php?id=<?php echo $row['movie_id'] ?> "class="link-dark"><i class="fas fa-trash-restore"></i></a>
                            <a href="permDelete.php?id=<?php echo $row['movie_id'] ?> "class="link-dark"><i class="fa-solid fa-trash fs-5"></i></a>
							</td>
						</tr>
						<?php
